...
function clsJASAPI(){
  ...
  this.createsession=function(p_sUsername, p_sPassword, p_sNewPassword1, p_sNewPassword2){
    var sCall=this.JASAPIURL("createsession") +
      ...
      "&password="+encodeURIComponent(sScramble(p_sPassword));
    if((p_sNewPassword1!=null)||(p_sNewPassword2!=null)){
      s+="&newpassword1=";
      if(p_sNewPassword1!=null){s+=encodeURIComponent(sScramble(p_sNewPassword1));};
      s+="&newpassword2=";
      if(p_sNewPassword2!=null){s+=encodeURIComponent(sScramble(p_sNewPassword2));};
    };
...
//==============================================================================
function sXor(p_s,p_key){
//==============================================================================
  var s='';
  for(i=0;i<p_s.length;i++){
   s=s+String.fromCharCode(p_key^p_s.charCodeAt(i));
  };
  return s;
};
//==============================================================================
...
//==========================================================================
function sScramble(p_sa){
//==========================================================================
  //lert('sScramble');
  for(u=0;u<p_sa.length;u++){
    switch(p_sa[u]){
    case 'A': p_sa[u]='C';break;
    case 'B': p_sa[u]='D';break;
    case 'C': p_sa[u]='A';break;
    case 'D': p_sa[u]='B';break;
    case 'E': p_sa[u]='G';break;
    case 'F': p_sa[u]='H';break;
    case 'G': p_sa[u]='E';break;
    case 'H': p_sa[u]='F';break;
    case 'I': p_sa[u]='J';break;
    case 'J': p_sa[u]='I';break;
    case 'K': p_sa[u]='O';break;
    case 'L': p_sa[u]='N';break;
    case 'M': p_sa[u]='T';break;
    case 'N': p_sa[u]='L';break;
    case 'O': p_sa[u]='K';break;
    case 'P': p_sa[u]='S';break;
    case 'Q': p_sa[u]='R';break;
    case 'R': p_sa[u]='Q';break;
    case 'S': p_sa[u]='P';break;
    case 'T': p_sa[u]='M';break;
    case 'U': p_sa[u]='Z';break;
    case 'V': p_sa[u]='X';break;
    case 'W': p_sa[u]='Y';break;
    case 'X': p_sa[u]='V';break;
    case 'Y': p_sa[u]='W';break;
    case 'Z': p_sa[u]='U';break;
    case 'a': p_sa[u]='l';break;
    case 'b': p_sa[u]='d';break;
    case 'c': p_sa[u]='t';break;
    case 'd': p_sa[u]='b';break;
    case 'e': p_sa[u]='n';break;
    case 'f': p_sa[u]='o';break;
    case 'g': p_sa[u]='h';break;
    case 'h': p_sa[u]='g';break;
    case 'i': p_sa[u]='r';break;
    case 'j': p_sa[u]='k';break;
    case 'k': p_sa[u]='j';break;
    case 'l': p_sa[u]='a';break;
    case 'm': p_sa[u]='p';break;
    case 'n': p_sa[u]='e';break;
    case 'o': p_sa[u]='f';break;
    case 'p': p_sa[u]='m';break;
    case 'q': p_sa[u]='u';break;
    case 'r': p_sa[u]='i';break;
    case 's': p_sa[u]='v';break;
    case 't': p_sa[u]='c';break;
    case 'u': p_sa[u]='q';break;
    case 'v': p_sa[u]='s';break;
    case 'w': p_sa[u]='y';break;
    case 'x': p_sa[u]='z';break;
    case 'y': p_sa[u]='w';break;
    case 'z': p_sa[u]='x';break;
    case '1': p_sa[u]='=';break;
    case '2': p_sa[u]='6';break;
    case '3': p_sa[u]='9';break;
    case '4': p_sa[u]='8';break;
    case '5': p_sa[u]='7';break;
    case '6': p_sa[u]='2';break;
    case '7': p_sa[u]='5';break;
    case '8': p_sa[u]='4';break;
    case '9': p_sa[u]='3';break;
    case '0': p_sa[u]='!';break;
    case '!': p_sa[u]='0';break;
    case '@': p_sa[u]='$';break;
    case '#': p_sa[u]='^';break;
...
//==============================================================================
  ...
  //lert('IPAD: ' + iPad.toString() +' datalen:'+p_sData.length.toString());
  ...
  for(i=0; i < p_sData.length; i++){
    ...
    //lert('Encrypt '+p_sData[i]+' to ' + p_sData.charCodeAt(i).toString() + ' mixed: '+ au1Mix[p_sData.charCodeAt(i)].toString());
  };

  for(i=0; i < au1.length; i++){
    au1[i]=au1[i]^au1Pub[i % 1024];
    //lert('encrypt xor to:'+au1[i].toString());
  };
...
//==============================================================================
  ...
  if(s.length>12){
    if(s.substring(0,10)=='JCRYPTPAD['){
      ...
      s=s.substring(x+1);
      //lert('s length:'+s.length.toString()+' iPad Valu:'+iPad.toString()+' :'+s);
...
//lert('ENCRYPT OUTPUT: ' + ss);
//ss = sJegasDecryptSingleKey(ss);
//lert('DECRYPT OUTPUT('+ss.length.toString()+'): ' + ss);
...
function bReqFields_Validate(){
  try{
    ...
    //lert('Leaving bReqFields_Validate');
    return bValid;
  }catch(eX){
    return true;
  };
...
//==============================================================================
  ...
  if(bSuccess==true){
    ...
    el.value=sScramble(el.value);
    var el=document.getElementById("newpassword1");
    el.value=sScramble(el.value);
    var el=document.getElementById("newpassword2");
    el.value=sScramble(el.value);
...
function settheme(p_sName,p_JSID){
  var sURL='.?jasapi=settheme&name='+encodeURIComponent(p_sName)+'&JSID='+p_JSID;
  try{
...
function seticontheme(p_sName,p_JSID){
  var sURL='.?jasapi=seticontheme&name='+encodeURIComponent(p_sName)+'&JSID='+p_JSID.toString();
  try{
    iwfRequestSync(sURL,null,null,callbacksettheme);
  }catch(eX){
    alert('JAS Server appears to be offline.');
...
function HeadersOn(p_JSID){
  var sURL='.?jasapi=setdisplayheaders&value=true&JSID='+p_JSID;
  try{
    iwfRequestSync(sURL,null,null,callbacksettheme);
  }catch(eX){
    alert('JAS Server appears to be offline.');
...
function HeadersOff(p_JSID){
  var sURL='.?jasapi=setdisplayheaders&value=false&JSID='+p_JSID;
  try{
    iwfRequestSync(sURL,null,null,callbacksettheme);
  }catch(eX){
    alert('JAS Server appears to be offline.');
...
function QuickLinksOn(p_JSID){
  var sURL='.?jasapi=setdisplayquicklinks&value=true&JSID='+p_JSID;
  try{
    iwfRequestSync(sURL,null,null,callbacksettheme);
  }catch(eX){
    alert('JAS Server appears to be offline.');
...
function QuickLinksOff(p_JSID){
  var sURL='.?jasapi=setdisplayquicklinks&value=false&JSID='+p_JSID;
  try{
    iwfRequestSync(sURL,null,null,callbacksettheme);
  }catch(eX){
    alert('JAS Server appears to be offline.');
...
function BackgroundRepeatOn(p_JSID){
  var sURL='.?jasapi=setbackgroundrepeat&value=true&JSID='+p_JSID;
  try{
    iwfRequestSync(sURL,null,null,callbacksettheme);
  }catch(eX){
    alert('JAS Server appears to be offline.');
...
function BackgroundRepeatOff(p_JSID){
  var sURL='.?jasapi=setbackgroundrepeat&value=false&JSID='+p_JSID;
  try{
    iwfRequestSync(sURL,null,null,callbacksettheme);
  }catch(eX){
    alert('JAS Server appears to be offline.');
...
//==============================================================================
function ResetSwitch(p_id){
  var el=null;
  /* alert("Entering ResetSwitch"); */
  el=document.getElementById(p_id);    /* alert("ResetSwitch A"); */el.style.display="";/* alert("ResetSwitch B"); */
  el=document.getElementById(p_id+"A");/* alert("ResetSwitch C"); */el.style.display="none";/* alert("ResetSwitch D"); */
  el=document.getElementById(p_id+"D");/* alert("ResetSwitch E"); */el.style.display="none";/* alert("ResetSwitch F"); */
  el=document.getElementById(p_id+"U");/* alert("ResetSwitch G"); */el.value='0';
  /* alert("Leaving ResetSwitch"); */
}
//==============================================================================

//lert('DEBUG: jegas.js Lives');
//==============================================================================
...
var WeekDayColor = "#777777";//"#FFEDA6"; //Background color of weekdays.
...
var HoverColor = "#FFFF00";//"#E0FF38"; //color when mouse move over.
...
function RenderCssCal(bNewCal)
{
  ...
  /* stock - vCalHeader = "<table " + CalBgColor + " background='" + ThemeBg + "' style=\"border:1px solid #000000; width:200px; \">\n"; */
  vCalHeader = "<table style=\"border:1px solid #000000; width:200px; \">\n";

...
Begin
  ...
  VCSetFGC(p_DataFG);VCSetBGC(p_DataBG);
  VCWrite(saTrueFalse(rKey.bShiftPressed));
  
  
  VCSetFGC(p_FG);VCSetBGC(p_BG);
  VCWriteXY(x,y+4,'   bLSHIFTPressed       = ');
  VCSetFGC(p_DataFG);VCSetBGC(p_DataBG);
  VCWrite(saTrueFalse(rKey.bLShiftPressed));
  VCSetFGC(p_FG);VCSetBGC(p_BG); 
  ...
  VCSetFGC(p_DataFG);VCSetBGC(p_DataBG);
  VCWrite(saTrueFalse(rKey.bRShiftPressed));
  VCSetFGC(p_FG);VCSetBGC(p_BG); 
  //VCWrite(' // Unreliable on Win32/Intel');
  ...
  VCSetFGC(p_DataFG);VCSetBGC(p_DataBG);
  VCWrite(saTrueFalse(rKey.bCNTLPressed));
  
  
  VCSetFGC(p_FG);VCSetBGC(p_BG);
  VCWriteXY(x,y+7,'   bALTPressed          = ');
  VCSetFGC(p_DataFG);VCSetBGC(p_DataBG);
  VCWrite(saTrueFalse(rKey.bALTPressed));
  VCSetFGC(p_FG);VCSetBGC(p_BG);

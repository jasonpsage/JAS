...
{ }
{
This is a test app - uncomment thelines you need foryour tests.

This application is used to test the ability to deliver database and context
information via tokens used in JAS to allow PHP, Html,Htm,Css,Javascript and
JAS pages naturally. This allows for reuse and assists making disparate system
graphically seamless with less effect for the web/graphics wizards.
Note: Thiis is CLAY, not a set application. This is one were the
commented code is as important as the live stuff. Its mainly a debugging tool.
}

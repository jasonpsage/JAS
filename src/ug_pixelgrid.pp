...
//============================================================================
  ...
  public
    ...
    // For Working with Images OWNED by this Class
    function MemPos(p_X:longint; p_Y:longint): cardinal;
    ...
    Procedure AdjustR(p_X: longint; p_Y: longint; p_Value: longint);
    Procedure AdjustG(p_X: longint; p_Y: longint; p_Value: longint);
    Procedure AdjustB(p_X: longint; p_Y: longint; p_Value: longint);
    Procedure AdjustA(p_X: longint; p_Y: longint; p_Value: longint);
    Procedure AdjustRGB(p_X: longint; p_Y: longint; p_R: longint; p_G: longint; p_B: longint);
    Procedure AdjustRGBA(p_X: longint; p_Y: longint; p_R: longint; p_G: longint; p_B: longint; p_A: longint);
...
begin
  ...
  begin
    ...
    writeln(f,';==============================================================================');
    writeln(f,';                     Copyright(c)2011 Jegas, LLC                              ');
    writeln(f,';==============================================================================');

...
//=============================================================================
  Public
    i8User: int64; // < I use sometimes, nope child classes inherit this.
                   // so ug_jfc_xxdl has this also as its a child class of
                   // this one.
...
Begin
  ...
  Begin
    try
      ...
      Writeln(f,'ListCount:',uItems);
      Writeln(f,'UID, lpPTR, i8User, saName, saDesc, saValue, TS');
      If movefirst Then
      Begin
        repeat

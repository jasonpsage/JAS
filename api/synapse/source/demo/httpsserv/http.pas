...
uses
  Classes, blcksock, winsock, Synautil, ssl_openssl, SysUtils;
...
begin
  ...
  try
    ...
    begin
      writeln('Error while accepting SSL connection: ' + Sock.SSL.LastErrorDesc);
      Exit;
    end;
  except
    writeln('Exception while accepting SSL connection');
    Exit;
  end;

...
//=============================================================================
{ }
// Populated woth data then passed to the create window function.
...
//=============================================================================
  ...
  Function Read_u1FrameSizeBG:Byte;//< read the frame sizing border background color
...
Begin
  ...
  VCWriteXY(p_iX,p_iY, saFixedLength(p_saLabel,1,p_iLabelWidth));
  VCSetFGC(gu1FrameWindowFG);
  VCWrite(saFixedLength(sRJustifyInt(p_iValue, p_iDataWidth),1,p_iDataWidth));
End;
//=============================================================================
...
Begin
  ...
  //  'bDone:'+sTrueFalse(bDone),SOURCEFILE);
  ...
  begin
    ...
    Begin
      ...
      Begin
        ...
        Begin
          //LOG(cnLog_Debug,201003031454,'ProcessKeyBoardMain - Before calling TWindow.ProcessKeyboard - gbUnhandledKeypress:'+sTrueFalse(gbUnhandledKeypress),SOURCEFILE);
          TWindow(JFC_XXDL(OBJECTSXXDL.lpItem).lpPtr).ProcessKeyboard(u4Key);
          //LOG(cnLog_Debug,201003031455,'ProcessKeyBoardMain - After Calling TWindow.ProcessKeyboard - gbUnhandledKeypress:'+sTrueFalse(gbUnhandledKeypress),SOURCEFILE);
...
Begin
  ...
  repeat
    ...
    If gFBDir.Item_bDir Then saEntry:=saEntry+DOSSLASH Else saEntry:=saEntry+' ';
...
Begin
  ...
  //        sTrueFalse(gFBDir.FoundNTh(gFBListBox.CurrentItem))+
  //       'Name:'+gFBDir.Item_saName+' bDir:'+sTrueFalse(gFBDir.Item_bDir),MB_OK);
...
{$ENDIF}
  ...
  MSG_WINPAINTVCb4CTL:
    Begin
      ...
      VCSetFGC(LightGray);
      VCSetBGC(gu1FrameWindowBG);
      WVCDataPairStr(2,2,28,5,'gbSBVisible:',sTrueFalse(gbSBVisible));
      WVCDataPairInt(2,3,28,5,'giVCStatusBarLastKnownYPos:',giVCStatusBarLastKnownYPos);
      WVCDataPairStr(2,4,28,5,'VCGetVisible:',sTrueFalse(bTempSBVisible));
...
{$ENDIF}
  ...
  MSG_WINPAINTVCb4CTL:
    Begin
      ...
      VCSetFGC(Yellow);
      VCWriteXY(iPlotCenter(WINLOGO.rW.Width,length(grJegasCOmmon.sAppTitle)),2,grJegasCOmmon.sAppTitle);
      
      VCSetFGC(White);
      iLine:=13;
      VCWriteXY(2,iLine,saFixedLength(saRepeatChar(' ',iPlotCenter(WINLOGO.rW.Width-4,length(grJegasCommon.sAppProductName)))+grJegasCommon.sAppProductName,1,WINLOGO.rW.Width)); iLine+=2;

      sa:='Version: ' + grJegasCommon.sVersion;
...
Begin
  ...
  //        sTrueFalse(WinHelpTopicXDL.FoundNTh(WinHelp_ctlListbox.CurrentItem))+
...
{$ENDIF}
  ...
  MSG_WINPAINTVCb4CTL:
    Begin
      iBookMarkMenu:=gMB.N;
      WVCDataPairStr(3, 3,36,10,'gbMenuEnabled:',sTrueFalse(gbMenuEnabled));
      WVCDataPairStr(3, 4,36,10,'gbMenuVisible:',sTrueFalse(gbMenuVisible));
      WVCDataPairStr(3, 5,36,10,'gbMenuDown:',sTrueFalse(gbMenuDown));
...
{$ENDIF}
  ...
  MSG_WINPAINTVCb4CTL:
    Begin
      ...
      iYPos:=4;
      WVCDataPairStr(3, iYPos,20,10,'SHIFT',sTrueFalse(bKeyIDShiftPressed(gu4Key)));iYPos+=1;
      WVCDataPairStr(3, iYPos,20,10,'CNTL',sTrueFalse(bKeyIDCntlPressed(gu4Key)));iYPos+=1;
      WVCDataPairStr(3, iYPos,20,10,'ALT',sTrueFalse(bKeyIDAltPressed(gu4Key)));iYPos+=1;
...
begin
  ...
  MSG_WINPAINTVCB4CTL: begin
    ...
    begin  
      ...
      VCWriteXY(2,iYPos,'C.bEnabled:'+sTrueFalse(WinDebugCtl.C.bEnabled));iYPos+=1;
      VCWrite(' C.bVisible:'+sTrueFalse(WinDebugCtl.C.bVisible));
      VCWrite(' C.bPrivate:'+sTrueFalse(WinDebugCtl.C.bPrivate));
      VCWrite(' C.lpOwner:'+inttostr(UINT(WinDebugCtl.C.lpOwner))+' ');
      VCWriteXY(2,iYPos,'C.bCanGetFocus:'+sTrueFalse(WinDebugCtl.C.bCanGetFocus));iYPos+=1;
      VCWrite(' C.bRedraw:'+sTrueFalse(WinDebugCtl.C.bRedraw));
      ...
      OBJ_INPUT              :begin
        ...
        VCWriteXY(2,iYPos,'IsPassword:'+sTrueFalse( tctlInput(WinDebugCtl.C.Item_lpPtr).IsPassword));iYPos+=1;
      ...
      VCWrite(' Sticky:'+sTrueFalse( tctlButton(WinDebugCtl.C.Item_lpPtr).Sticky));
      ...
      OBJ_CHECKBOX           :begin
        ...
        VCWrite(' Checked:'+sTrueFalse(tctlCheckBox(WinDebugCtl.C.Item_lpPtr).Checked));
        VCWrite(' RadioStyle:'+sTrueFalse(tctlCheckBox(WinDebugCtl.C.Item_lpPtr).RadioStyle)+' ');
      ...
      OBJ_LISTBOX            :begin
        ...
        VCWrite(' Selected:'+sTrueFalse(tctlListBox(WinDebugCtl.C.Item_lpPtr).Selected));
        VCWrite(' ListCount:'+inttostr(tctlListBox(WinDebugCtl.C.Item_lpPtr).Listcount)+' ');
        VCWriteXY(2,iYPos,'ShowCheckMarks:'+sTrueFalse( tctlListBox(WinDebugCtl.C.Item_lpPtr).ShowCheckMarks)+' ');iYPos+=1;
...
Begin
  ...
  {$IFDEF DEBUGLOGBEGINEND}
  DebugIn('UpdateSageUI (gbTrulyIdle:'+sTrueFalse(gbTrulyIdle)+') MilliSeconds Since Last Update:' +inttostr(iMilliSeconds)+ ' (Refresh Every '+inttostr(cnSAGEUI_ScreenUpdateMilliSecondInterval)+' Milliseconds)',SOURCEFILE);
  {$ENDIF}
  ...
  Begin
    ...
    Begin
      ...
      VCSetFGC(gu1ButtonFG);
      VCSetBGC(gu1ButtonBG);
      VCWriteXY(giConsoleWidth-19,2, FormatDateTime(csDATETIMEFORMAT,dtNow));
  ...
  uRESULT_UsersMainMessageHandler: UINT;
                        ...
                        Begin
                          ...
                          Begin
                            ...
                            Begin
                              uPtr:=uint64(JFC_XXDLITEM(OBJECTSXXDL.lpItem).ID[1]);
                              If pointer(uPtr)<>nil Then // The Entry Point Can Not Be Null
                              Begin
                                TempVC:=GetActiveVC;
                                SetActiveVC(guVCDebugWindows);
                                ...
                                begin
                                  ...
                                  begin
                                    ...
                                    VCSetFGC(LightGray);VCWriteXY(1,i4Y,'gbModal:              ');VCSetFGC(White);VCWrite(saFixedLength(sTrueFalse(gbModal),1,5));i4Y+=1;
                                    if OBJECTSXXDL.FoundItem_UID(gi4WindowHasFocusUID) then
                                    begin
                                ...
                                SetActiveVC(TempVC);
                                uPtr:=uint(JFC_XXDLITEM(OBJECTSXXDL.lpItem).ID[1]);
                                pointer(UserMsgHandler):=pointer(uPtr);
...
Begin
  ...
  Begin
    ...
    Begin
      //SageLog(1,'tc.bCanGetFocus DL^.PTR=DL^.PTR? ->'+sTrueFalse(DL^.PTR=DL^.PTR));
      Case Item_ID1 Of
      OBJ_LABEL       :Result:=
        tCtlLabel(Item_lpPTR).bEnabled and
...
Begin
  ...
  //SageLog(1,'VCGetVisible:'+sTrueFalse(VCGetVisible));
  //sagelog(1,'(((giConsoleHeight-VCHeight)-1) <= VCGetY):'+sTrueFalse((((giConsoleHeight-VCHeight)-1) <= VCGetY)));
...
Begin
  {$IFDEF DEBUGLOGBEGINEND}
  DebugIn('TWindow.CntlChangeFocus - p_Forward:'+sTrueFalse(p_Forward)+' p_Keypress:'+sTrueFalse(p_Keypress),SOURCEFILE);
  {$ENDIF}
...
Begin
  ...
  Begin
    ...
    //Log(cnLog_DEBUG, 200609191018,' rw.bEnabled: '+ sTrueFalse(rw.bEnabled),SOURCEFILE);
    //Log(cnLog_DEBUG, 200609191018,' gbModeless: '+ sTrueFalse(gbModeless),SOURCEFILE);
